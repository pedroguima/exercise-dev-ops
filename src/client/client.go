...
var (
	...
	serverAddr         = flag.String("server_addr", "tcexercise.thisispedro.com:8888", "The server address in the format of host:port")
...
func main() {
	...
	if *tls {
		if *caFile == "" {
			*caFile = testdata.Path("testdata/example.crt")
		}
